...
const productQuestionCopies = {
  ...
  ru: {
    vs: [
      ['Что означает VS в коньяке?', 'VS означает Very Special («особый»): самый молодой коньячный спирт в купаже выдерживается в дубе не менее двух лет. Стиль остаётся молодым, ярким и фруктовым.'],
      ['Почему стоит выбрать VS из Fins Bois?', 'Коньячные спирты из Fins Bois естественным образом отличаются округлостью, мягкостью и фруктовостью. В этом VS Léopold Croizet они подчёркивают ноты груши, персика и цветка виноградной лозы.'],
      ['Как подавать этот VS?', 'Он подходит для коктейлей и лонг-дринков с тоником или имбирным пивом, а также для подачи со льдом. В чистом виде его подают небольшой порцией в тюльпановидном бокале.'],
    ],
    vsop: [
      ['Что означает VSOP в коньяке?', 'VSOP означает Very Superior Old Pale: самый молодой коньячный спирт в купаже выдерживается в дубе не менее четырёх лет. Благодаря этому вкус становится округлее, раскрывая сливу, абрикос и мягкие пряности.'],
      ['Почему Fins Bois особенно подходит для VSOP?', 'Крю Fins Bois естественным образом придаёт округлость, мягкость и фруктовость. В этом VSOP Léopold Croizet оно подчёркивает ноты томлёных фруктов и свежий финал с гвоздикой.'],
      ['Как подавать этот VSOP?', 'Его можно пить чистым из тюльпановидного бокала, подавать со льдом в качестве аперитива или использовать в изысканном коктейле. Он также хорошо сочетается с десертами из жёлтых фруктов и миндаля.'],
    ],
    napoleon: [
      ['Что означает Napoléon в коньяке?', 'Napoléon относится к возрастным обозначениям коньяков с выдержкой не менее шести лет. За это время развиваются ноты сухофруктов, тёплого дерева и пряностей.'],
      ['Какие ноты раскрывает этот Napoléon?', 'В нём звучат арахис, миндаль, фундук, ваниль и ириска, а финал отличается перечной пряностью. Вкус объёмный и древесный, но сохраняет щедрый характер Fins Bois.'],
      ['Как его подавать?', 'Подавайте чистым, небольшими порциями, в тюльпановидном бокале. Он особенно хорош в конце ужина, с сухофруктами, кофе или не слишком сладким тёмным шоколадом.'],
    ],
    xo: [
      ['Что означает XO в коньяке?', 'XO означает Extra Old: самый молодой коньячный спирт в купаже выдерживается не менее десяти лет. Такая зрелость придаёт структуру, округлость и продолжительность.'],
      ['Что такое рансьо в этом XO?', 'Рансьо рождается благодаря долгому взаимодействию коньячного спирта, дуба и времени. Здесь оно раскрывается в продолжительном финале нотами кожи, табака и сухоцветов.'],
      ['С чем его сочетать?', 'В чистом виде, из тюльпановидного бокала, он прекрасно сочетается с тёмным шоколадом, миндалём, апельсиновыми десертами или эспрессо.'],
    ],
    'xo-exception': [
      ['Почему его называют XO Exception?', 'Он принадлежит к категории XO, но отличается ещё большей ароматической глубиной: сухофрукты, цукаты, старое дерево и янтарные оттенки.'],
      ['Что даёт гармонично интегрированная древесность?', 'Дуб не доминирует: он округляет вкус и сопровождает ноты корицы, табака и цукатов. Впечатление получается насыщенным, но цельным.'],
      ['Как его дегустировать?', 'Дайте ему постепенно раскрыться в тюльпановидном бокале, не согревая напиток слишком сильно. Он самодостаточен, но также хорошо сочетается с насыщенным тёмным шоколадом.'],
    ],
    extra: [
      ['Что означает обозначение Extra?', 'Extra относится к высшим возрастным обозначениям и соответствует тому же нормативному уровню, что и XO: самый молодой коньячный спирт выдерживается не менее десяти лет.'],
      ['Почему здесь говорят о рансьо?', 'Рансьо свидетельствует о долгой выдержке и раскрывается цукатами, шоколадом, пряностями и глубокой древесностью. В Extra Léopold Croizet белые цветы сохраняют свежесть композиции.'],
      ['Когда его подавать?', 'Лучше всего пить его чистым после ужина или подать к пряному десерту. Мускатный орех, корица и шоколад особенно хорошо перекликаются с его ароматами.'],
    ],
    excellence: [
      ['Что означает название Excellence?', 'Excellence относится к возрастным обозначениям Cognac. Здесь представлен очень старый Fins Bois, созданный ради сложности и исключительной продолжительности.'],
      ['Что дают очень старые коньячные спирты из Fins Bois?', 'Они сохраняют фруктовые и цветочные ноты, а со временем приобретают кедр, сандал и рансьо. Кокос, маракуйя и эвкалипт создают неповторимый характер.'],
      ['Как его дегустировать?', 'Налейте небольшую порцию в тюльпановидный бокал и дайте аромату раскрыться. Это Cognac для медленной, вдумчивой дегустации.'],
    ],
    heritage: [
      ['Почему Héritage?', 'Héritage — семейный купаж, представленный как душа дома и результат труда четырёх поколений. Хрустальный флакон подчёркивает его связь с семейным наследием.'],
      ['Каков его характер?', 'Он мощный, почти животный, с нотами кожи, табака, старого дерева и глубоким рансьо. Цветочный, свежий финал отличается исключительной продолжительностью.'],
      ['Как его подавать?', 'Подавайте чистым, совсем небольшой порцией, в тюльпановидном бокале. Дайте ему подышать несколько минут: этому коньяку нужны тишина и время.'],
    ],
    valentine: [
      ['Почему Valentine XO?', 'Valentine XO соединяет глубину XO с более камерным форматом 350 мл. Это намеренно щедрое и чувственное прочтение времени.'],
      ['Какие ноты доминируют?', 'Грецкий орех, вишня, шоколад, корица и имбирь звучат и в аромате, и во вкусе. Характер тёплый, пряный и запоминающийся.'],
      ['С чем его сочетать?', 'Попробуйте его чистым с шоколадным десертом, миндалём или эспрессо. Небольшой порции достаточно, чтобы продлить удовольствие, не утяжеляя его.'],
    ],
  },
  da: {
    vs: [
