...
const editorialCopy = {
  da: [
    ...
    ['I want to receive some news time to time', 'Jeg ønsker at modtage nyheder fra tid til anden'],
    ["Pour vous désinscrire, merci d'envoyer un e-mail à cognac@mdpierrre.com.", 'For at afmelde dig bedes du sende en e-mail til cognac@mdpierrre.com.'],
  ...
  sv: [
    ...
    ['I want to receive some news time to time', 'Jag vill få nyheter då och då'],
    ["Pour vous désinscrire, merci d'envoyer un e-mail à cognac@mdpierrre.com.", 'För att avanmäla dig, skicka ett e-postmeddelande till cognac@mdpierrre.com.'],
  ...
  no: [
    ...
    ['I want to receive some news time to time', 'Jeg ønsker å motta nyheter fra tid til annen'],
    ["Pour vous désinscrire, merci d'envoyer un e-mail à cognac@mdpierrre.com.", 'For å melde deg av, vennligst send en e-post til cognac@mdpierrre.com.'],
